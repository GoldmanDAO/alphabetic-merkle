...
fn bench_merkle(c: &mut Criterion) {
    ...
    c.bench_function("Test 100000", |b| {
        b.iter(|| get_merkle_root(&rnd_addresses[0..100000].to_vec()))
    });
    c.bench_function("Test 1000000", |b| {
        b.iter(|| get_merkle_root(&rnd_addresses[0..1000000].to_vec()))
    });
}
